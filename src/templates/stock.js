    ...
    <Layout>
        <article className="centerdivArticle">
            ...
            <div className="sheet__inner">
                ...
                <h1 className="sheet__title">{data.datoCmsFeatured.title}</h1>
                <p className="sheet__lead">{data.datoCmsFeatured.excerpt}</p>
                ...
                <div className="sheet__gallery">
                    <Img fluid={data.datoCmsFeatured.coverImage.fluid} />
                </div>
            </div>
        </article>
